...
public class LoginScr : mScreen, IActionListener
{
	...
	protected void doRegister(string user)
	{
		...
		Service.gI().requestRegister(user, tfPass.getText(), Rms.loadRMSString("userAo1" + ServerListScreen.ipSelect), Rms.loadRMSString("passAo" + ServerListScreen.ipSelect), GameMidlet.VERSION);
	...
	public void doLogin()
	{
		...
		else if (Rms.loadRMSString("userAo1" + ServerListScreen.ipSelect) != null && !Rms.loadRMSString("userAo1" + ServerListScreen.ipSelect).Equals(string.Empty))
		{
			isLogin2 = true;
		}
		else
		...
		{
			text = Rms.loadRMSString("userAo1" + ServerListScreen.ipSelect);
			text2 = "a";
		}
	...
	public void perform(int idAction, object p)
	{
		...
		{
			GameCanvas.startWaitDlg();
			string text = Rms.loadRMSString("userAo1" + ServerListScreen.ipSelect);
			if (text == null || text.Equals(string.Empty))
			{
