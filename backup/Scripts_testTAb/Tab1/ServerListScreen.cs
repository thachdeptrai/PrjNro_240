...
public class ServerListScreen : mScreen, IActionListener
{
	...
	public static string ipEncrypt = ConfigMod.ipEncrypt;
	public static int ipEncryptKey = ConfigMod.ipEncryptKey;
	...
	private void initCommand()
	{
		...
		if (text == null)
		{
			if (Rms.loadRMS("userAo1" + ipSelect) != null)
			{
				nCmdPlay = 1;
			}
		}
			...
			case 3:
				{
					...
					bool flag2 = Rms.loadRMSString("userAo1" + ipSelect) != null && !Rms.loadRMSString("userAo1" + ipSelect).Equals(string.Empty);
					if (!num && !flag2)
					{
						GameCanvas.connect();
						string text3 = Rms.loadRMSString("userAo1" + ipSelect);
			...
			case 11:
				{
					...
					GameCanvas.loginScr.switchToMe();
					string text2 = Rms.loadRMSString("userAo1" + ipSelect);
