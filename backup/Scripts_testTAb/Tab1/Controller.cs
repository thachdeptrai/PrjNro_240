                ...
                case -74:
                    {
                        ...
                        if (!GameCanvas.isGetResourceFromServer())
                        {
                            ...
                            if (Rms.loadRMSString("acc") != null || Rms.loadRMSString("userAo11" + ServerListScreen.ipSelect) != null)
                            {
                ...
                case 1:
                    {
                        ...
                        Rms.saveRMSString("userAo11" + ServerListScreen.ipSelect, string.Empty);
                        GameCanvas.endDlg();
