                ...
                case -74:
                    {
                        ...
                        if (!GameCanvas.isGetResourceFromServer())
                        {
                            ...
                            if (Rms.loadRMSString("acc2") != null || Rms.loadRMSString("userAo1" + ServerListScreen.ipSelect) != null)
                            {
                ...
                case 1:
                    {
                        ...
                        Rms.saveRMSString("userAo1" + ServerListScreen.ipSelect, string.Empty);
                        GameCanvas.endDlg();
                ...
                case 4:
                    {
                        ...
                        {
                            Rms.saveRMSString("acc1", string.Empty);
                            Rms.saveRMSString("pass1", string.Empty);
                        }
                        else
                        {
                            Rms.saveRMSString("userAo1" + ServerListScreen.ipSelect, string.Empty);
