...
public class Panel : IActionListener, IChatable
{
    ...
    private void paintPetSkill(mGraphics g, bool isPet2)
    {
        ...
        for (int i = 0; i < num; i++)
        {
            ...
            if (i == 0)
            {
                ...
                string st = mResources.HP + " " + mResources.root + ": " + NinjaUtil.FormatNumber(pet.cHPGoc);
                mFont.tahoma_7b_blue.drawString(g, st, num2 + 5, num3 + 3, 0);
                mFont.tahoma_7_green2.drawString(g, NinjaUtil.FormatNumber(pet.cHPGoc + 1000) + " " + mResources.potential + ": " + mResources.increase + " " + pet.hpFrom1000TiemNang, num2 + 5, num3 + 15, 0);
            }
            if (i == 1)
            {
                SmallImage.drawSmallImage(g, 569, num5 + 4, num6 + 4, 0, 0);
                string st2 = mResources.KI + " " + mResources.root + ": " + NinjaUtil.FormatNumber(pet.cMPGoc);
                mFont.tahoma_7b_blue.drawString(g, st2, num2 + 5, num3 + 3, 0);
                mFont.tahoma_7_green2.drawString(g, NinjaUtil.FormatNumber(pet.cMPGoc + 1000) + " " + mResources.potential + ": " + mResources.increase + " " + pet.mpFrom1000TiemNang, num2 + 5, num3 + 15, 0);
            }
            if (i == 2)
            {
                SmallImage.drawSmallImage(g, 568, num5 + 4, num6 + 4, 0, 0);
                string st3 = mResources.hit_point + " " + mResources.root + ": " + NinjaUtil.FormatNumber(pet.cDamGoc);
                mFont.tahoma_7b_blue.drawString(g, st3, num2 + 5, num3 + 3, 0);
                mFont.tahoma_7_green2.drawString(g, NinjaUtil.FormatNumber(pet.cDamGoc * 100) + " " + mResources.potential + ": " + mResources.increase + " " + pet.damFrom1000TiemNang, num2 + 5, num3 + 15, 0);
            }
            if (i == 3)
            {
    ...
    private void paintSkill(mGraphics g)
    {
        ...
        for (int i = 0; i < num + 6; i++)
        {
            ...
            {
                SmallImage.drawSmallImage(g, 567, num5 + 4, num6 + 4, 0, 0);
                string st = mResources.HP + " " + mResources.root + ": " + NinjaUtil.FormatNumber(Char.myCharz().cHPGoc);
                mFont.tahoma_7b_blue.drawString(g, st, num2 + 5, num3 + 3, 0);
                mFont.tahoma_7_green2.drawString(g, NinjaUtil.FormatNumber(Char.myCharz().cHPGoc + 1000) + " " + mResources.potential + ": " + mResources.increase + " " + Char.myCharz().hpFrom1000TiemNang, num2 + 5, num3 + 15, 0);
            }
            if (i == 1)
            {
                SmallImage.drawSmallImage(g, 569, num5 + 4, num6 + 4, 0, 0);
                string st2 = mResources.KI + " " + mResources.root + ": " + NinjaUtil.FormatNumber(Char.myCharz().cMPGoc);
                mFont.tahoma_7b_blue.drawString(g, st2, num2 + 5, num3 + 3, 0);
                mFont.tahoma_7_green2.drawString(g, NinjaUtil.FormatNumber(Char.myCharz().cMPGoc + 1000) + " " + mResources.potential + ": " + mResources.increase + " " + Char.myCharz().mpFrom1000TiemNang, num2 + 5, num3 + 15, 0);
            }
            if (i == 2)
            {
                SmallImage.drawSmallImage(g, 568, num5 + 4, num6 + 4, 0, 0);
                string st3 = mResources.hit_point + " " + mResources.root + ": " + NinjaUtil.FormatNumber(Char.myCharz().cDamGoc);
                mFont.tahoma_7b_blue.drawString(g, st3, num2 + 5, num3 + 3, 0);
                mFont.tahoma_7_green2.drawString(g, NinjaUtil.FormatNumber(Char.myCharz().cDamGoc * 100) + " " + mResources.potential + ": " + mResources.increase + " " + Char.myCharz().damFrom1000TiemNang, num2 + 5, num3 + 15, 0);
            }
            if (i == 3)
            {
                SmallImage.drawSmallImage(g, 721, num5 + 4, num6 + 4, 0, 0);
    ...
    {
        Char pet = isPet2 ? Char.MyPet2z() : Char.myPetz();
        mFont.tahoma_7_yellow.drawString(g, mResources.power + ": " + NinjaUtil.FormatNumber(pet.cPower), X + 60, 4, mFont.LEFT, mFont.tahoma_7_grey);
        if (pet.cPower > 0)
        {
    ...
    {
        Char pet = isPet2 ? Char.MyPet2z() : Char.myPetz();
        mFont.tahoma_7b_white.drawString(g, "HP: " + NinjaUtil.FormatNumber(pet.cHP) + "/" + NinjaUtil.FormatNumber(pet.cHPFull), X + 60, 4, mFont.LEFT, mFont.tahoma_7b_dark);
        mFont.tahoma_7b_white.drawString(g, "MP: " + NinjaUtil.FormatNumber(pet.cMP) + "/" + NinjaUtil.FormatNumber(pet.cMPFull), X + 60, 16, mFont.LEFT, mFont.tahoma_7b_dark);
        ...
        mFont.tahoma_7_yellow.drawString(g, mResources.potential2 + ": " + NinjaUtil.FormatNumber(pet.cTiemNang), X + 60, 38, mFont.LEFT, mFont.tahoma_7_grey);
    }
    ...
    private void paintCharInfo(mGraphics g, Char c)
    {
        ...
        mFont.tahoma_7_yellow.drawString(g, mResources.power + ": " + NinjaUtil.FormatNumber(c.cPower), X + 60, 38, mFont.LEFT, mFont.tahoma_7_grey);
    }
    ...
    private void paintSkillInfo(mGraphics g)
    {
        ...
        mFont.tahoma_7_white.drawString(g, string.Empty + NinjaUtil.FormatNumber(Char.myCharz().cTiemNang), X + ((GameCanvas.gameTick % 20 > 10) ? (GameCanvas.gameTick % 4 / 2) : 0) + 45 + (W - 50) / 2, 26, mFont.CENTER);
    ...
    {
        mFont.tahoma_7_yellow.drawString(g, mResources.HP + ": " + NinjaUtil.FormatNumber(Char.myCharz().cHP) + " / " + NinjaUtil.FormatNumber(Char.myCharz().cHPFull), X + 60, 2, mFont.LEFT, mFont.tahoma_7_grey);
        mFont.tahoma_7_yellow.drawString(g, mResources.KI + ": " + NinjaUtil.FormatNumber(Char.myCharz().cMP) + " / " + NinjaUtil.FormatNumber(Char.myCharz().cMPFull), X + 60, 14, mFont.LEFT, mFont.tahoma_7_grey);
        mFont.tahoma_7_yellow.drawString(g, mResources.hit_point + ": " + NinjaUtil.FormatNumber(Char.myCharz().cDamFull), X + 60, 26, mFont.LEFT, mFont.tahoma_7_grey);
    ...
    {
        mFont.tahoma_7_yellow.drawString(g, mResources.HP + ": " + NinjaUtil.FormatNumber(Char.myCharz().cHP) + " / " + NinjaUtil.FormatNumber(Char.myCharz().cHPFull), x, y + 2, mFont.LEFT, mFont.tahoma_7_grey);
        mFont.tahoma_7_yellow.drawString(g, mResources.KI + ": " + NinjaUtil.FormatNumber(Char.myCharz().cMP) + " / " + NinjaUtil.FormatNumber(Char.myCharz().cMPFull), x, y + 14, mFont.LEFT, mFont.tahoma_7_grey);
        mFont.tahoma_7_yellow.drawString(g, mResources.hit_point + ": " + NinjaUtil.FormatNumber(Char.myCharz().cDamFull), x, y + 26, mFont.LEFT, mFont.tahoma_7_grey);
    ...
    private void paintPetStatusInfo(mGraphics g, bool isPet2)
    {
        ...
        mFont.tahoma_7b_white.drawString(g, "HP: " + NinjaUtil.FormatNumber(pet.cHP) + "/" + NinjaUtil.FormatNumber(pet.cHPFull), X + 60, 4, mFont.LEFT, mFont.tahoma_7b_dark);
        mFont.tahoma_7b_white.drawString(g, "MP: " + NinjaUtil.FormatNumber(pet.cMP) + "/" + NinjaUtil.FormatNumber(pet.cMPFull), X + 60, 16, mFont.LEFT, mFont.tahoma_7b_dark);
        mFont.tahoma_7_yellow.drawString(g, mResources.critical + ": " + NinjaUtil.FormatNumber(pet.cCriticalFull) + "   " + mResources.armor + ": " + (pet.cDefull), X + 60, 27, mFont.LEFT, mFont.tahoma_7_grey);
    ...
    private void SetTypePlayerInfo()
    {
        string content = "Tộc: " + (Char.myCharz().cgender == 0 ? "Trái Đất" : Char.myCharz().cgender == 1 ? "Namek" : "Xayda") + "\n" +
            "HP: " + NinjaUtil.FormatNumber(Char.myCharz().cHP) + " / " + NinjaUtil.FormatNumber(Char.myCharz().cHPFull) + "\n" +
            "KI: " + NinjaUtil.FormatNumber(Char.myCharz().cMP) + " / " + NinjaUtil.FormatNumber(Char.myCharz().cMPFull) + "\n" +
            "SĐ: " + NinjaUtil.FormatNumber(Char.myCharz().cDamFull) + "\n" +
    ...
    private void doFireSkill()
    {
        ...
        if (selected == 0 || selected == 1 || selected == 2 || selected == 3 || selected == 4 || selected == 5)
        {
            ...
            if (selected == 3)
            {
                ...
                {
                    GameCanvas.startOKDlg(mResources.not_enough_potential_point1 + NinjaUtil.FormatNumber(Char.myCharz().cTiemNang) + mResources.not_enough_potential_point2 + NinjaUtil.getMoneys(50000 + Char.myCharz().cDefGoc * 1000));
                    return;
                }
    ...
    private void DoFirePetSkill()
    {
        ...
        if (selected == 0 || selected == 1 || selected == 2 || selected == 3 || selected == 4)
        {
            ...
            if (selected == 3)
            {
                ...
                {
                    GameCanvas.startOKDlg(mResources.not_enough_potential_point1 + NinjaUtil.FormatNumber(cTiemNang) + mResources.not_enough_potential_point2 + NinjaUtil.getMoneys(50000 + cDefGoc * 1000), isError: false);
                    return;
                }
                long number = 2 * (cDefGoc + 5) / 2L * 100000;
                long number2 = 10L * (2 * (cDefGoc + 5) + 9) / 2 * 100000;
